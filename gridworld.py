...
class Grid(object):
    ...
    def __init__(self, w, h, gridmap=None):
        self.w = w
        self.h = h
    ...
    def grid_state(self):
        return {'gridmap':self.gridmap, 'agentinfo':[(k.loc, k.__class__) for k in self.agentlist], 'grid_img':self.grid_img()}
    def step(self):
        #move agents
